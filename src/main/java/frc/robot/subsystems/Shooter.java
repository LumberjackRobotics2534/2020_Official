...
public class Shooter extends SubsystemBase {
  ...
  public void shoot(JoystickButton button) {
    if(button.get()){
    rpm = SmartDashboard.getNumber("RPM", 0.0);
		double targetVelocity_UnitsPer100ms =  -rpm * 2048 / 600;//was -3387.5
  ...
  public void periodic() {
    rpms = -shooterMotor.getSelectedSensorVelocity()*600 / 2048;
    SmartDashboard.putNumber("Actual RPM", rpms);
  }
}
